...
def trained_model_asset(
    ...
    model_config = context.resources.model_deployments_config_resource.load_config(model_name)
...
def model_inference_asset(
    ...
    features = model.get_features(forecast_date, region_id, context.resources.duck_db_resource)
    ...
    context.add_output_metadata({
        "mlflow_model_uri": mlflow_resource.get_deployed_model_uri(model, avalanche_season, region_id),
        "release": model.release,
